...
> and their reversals are in `docs/DECISIONS.md` (D1–D27). There are **three live
> plans**: `docs/PLAN_NEXT.md` for repo quality, `docs/PLAN_IDENTITY.md` for the
> current milestone and `docs/PLAN_ANATOMED.md` as its unstarted input. The
> approved XR-2 design gate is `docs/XR2_DESIGN_DECISIONS.md`. ⚠️
> `docs/PLAN_INTEGRATION.md` is **finished and historical** — all five of its
> items landed — and this box described it as live long after that stopped being
> true; `docs/README.md` had it right. `docs/ROADMAP.md` holds the phases.
>
