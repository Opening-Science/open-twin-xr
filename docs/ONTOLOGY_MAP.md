...
Every mapping from a body system to a nomenclature term that this repository holds, and — more importantly — which of them actually reach the shipped assets. 2,263 distinct terms across 10 systems.
...
| Z-Anatomy | FMA | 1,482 | 1,482 | 1,479 | per structure and per side |
...
<details>
<summary><strong>nervous</strong> — 341 terms</summary>
...
| `FMA:60184` | Vestibule | right | Z-Anatomy |
| `FMA:60185` | Vestibule | left | Z-Anatomy |
